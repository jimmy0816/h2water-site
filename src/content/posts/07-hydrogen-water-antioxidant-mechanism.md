---
title: "氫水抗氧化原理：選擇性清除自由基的科學機制"
description: "氫水為什麼被稱為「選擇性抗氧化劑」？本文從自由基的基礎知識出發，深入解析分子氫如何精準清除有害的羥自由基，同時保留細胞正常訊號所需的活性氧，並整理多篇 PubMed 臨床研究結果。"
pubDate: 2026-03-10
category: "氫水科學"
tags: ["氫水抗氧化", "自由基", "氧化壓力", "分子氫機制"]
author: "H₂ Water Lab"
...
在生物體內，與健康最相關的自由基統稱為**活性氧（Reactive Oxygen Species，ROS）**，包含幾種主要類型：
...
維生素 C（抗壞血酸）、維生素 E（生育酚）、多酚類等傳統抗氧化劑的作用原理是**捐出電子**，讓自由基穩定化。
...
研究結果顯示：H₂ 能選擇性地與氧化還原電位最高的 ROS 反應，主要是**羥自由基（·OH）**和**過氧亞硝酸根（ONOO⁻）**，而不與超氧自由基（O₂·⁻）、過氧化氫（H₂O₂）或一氧化氮（NO）反應。

> Ohsawa et al., *Nature Medicine* (2007), PMID: 17486089
> DOI: 10.1038/nm1577

這個選擇性源於化學反應的熱力學門檻。H₂ 與 ·OH 的反應在熱力學上是自發的（放熱反應，ΔG 為負），反應速率極快；但與電位較低的 H₂O₂ 或 O₂·⁻ 的反應則在常溫生理條件下不會自然發生。
...
> LeBaron et al., *Diabetes Metab Syndr Obes* (2020), PMID: 32273740
...
- ◉ **機制研究（選擇性清除 ·OH）**：証據充分，已由多個獨立實驗室重複驗證
- ◉ **Nrf2 通路活化**：動物模型證據強，人體間接證據支持
- ◐ **臨床氧化壓力指標改善（8-OHdG、MDA）**：初步 RCT 結果正面，但需要更大規模試驗確認
- ◐ **抗慢性發炎的臨床效果**：初步研究顯示潛力，尚需大規模 RCT
- ◠ **NF-κB 抑制的人體直接驗證**：目前主要為細胞與動物研究，人體機制待確認
...
1. Ohsawa I, et al. Hydrogen acts as a therapeutic antioxidant by selectively reducing cytotoxic oxygen radicals. *Nat Med.* 2007;13(6):688-94. PMID: [17486089](https://pubmed.ncbi.nlm.nih.gov/17486089/) | DOI: 10.1038/nm1577

2. Ohta S. Recent progress toward hydrogen medicine: potential of molecular hydrogen for preventive and therapeutic applications. *Curr Pharm Des.* 2011;17(22):2241-52. PMID: [21736547](https://pubmed.ncbi.nlm.nih.gov/21736547/)
...
4. Hydrogen-rich water reduces inflammatory responses and prevents apoptosis of peripheral blood cells in healthy adults: a randomized, double-blind, controlled trial. PMID: [32699287](https://pubmed.ncbi.nlm.nih.gov/32699287/)

5. Ishibashi T, et al. Consumption of water containing a high concentration of molecular hydrogen reduces oxidative stress and disease activity in patients with rheumatoid arthritis: an open-label pilot study. *Med Gas Res.* 2012;2(1):27. PMID: [23031079](https://pubmed.ncbi.nlm.nih.gov/23031079/)

6. Zhang et al. Hydrogen Attenuated Inflammation Response and Oxidative in Hypoxic Ischemic Encephalopathy via Nrf2 Mediated the Inhibition of NLRP3 and NF-κB. *Front Pharmacol.* 2022. PMID: [34953939](https://pubmed.ncbi.nlm.nih.gov/34953939/)

7. Ge L, et al. Molecular hydrogen: a therapeutic antioxidant and beyond. *Med Gas Res.* 2017;7(1):45-48. PMC: [PMC5223313](https://pmc.ncbi.nlm.nih.gov/articles/PMC5223313/)
